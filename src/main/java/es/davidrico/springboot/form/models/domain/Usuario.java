package es.davidrico.springboot.form.models.domain;
...
import es.davidrico.springboot.form.validation.IdentificadorRegex;
import es.davidrico.springboot.form.validation.Requerido;
...
public class Usuario {
	...
	//@Pattern(regexp = "[0-9]{2}[.][\\d]{3}[.][\\d]{3}[-][A-Z]{1}") // SIN ESPACIOS.. CON ESPACIO MAARCA ERROR ---> [0-9]{2}[.][\\d]{3}...
	@IdentificadorRegex
